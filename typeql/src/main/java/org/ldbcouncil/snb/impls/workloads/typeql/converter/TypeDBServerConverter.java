package org.ldbcouncil.snb.impls.workloads.typeql.converter;
...
public class TypeDBServerConverter extends Converter {
    ...
    public static Iterable<String> arrayToStringArray(Concept r, int column) throws TypeDBException {
    ...
    public static Iterable<Long> arrayToLongArray( r, int column) throws TypeDBException {
        String value = r.getString(column);
        if (value == null) {
            return new ArrayList<>();
        } else {
    ...
    public static Iterable<LdbcQuery1Result.Organization> arrayToOrganizationArray(ResultSet r, int column) throws TypeDBException {
        String value = r.getString(column);
        if (value == null) {
            return new ArrayList<>();
        } else {
    ...
    public static Iterable<List<Object>> arrayToObjectArray(ResultSet r, int column) throws TypeDBException {
        String value = r.getString(column);
        if (value == null) {
            return new ArrayList<>();
        } else {
    ...
    public static long stringTimestampToEpoch(ResultSet r, int column) throws TypeDBException {
